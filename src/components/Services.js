...
import service_section_img1 from "../images/services/service-1.png";
import service_section_img2 from "../images/services/service-2.png";
import service_section_img3 from "../images/services/service-3.png";
  ...
  <div className="container">
    ...
    <div className="row">
      ...
      <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
        <div className="services__pic">
          <img src={service_section_img1} alt="marketing illustration" className="img-fluid"/>
        </div>
      </div>
    </div>
    ...
    <div className="row">
      <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
        <div className="services__pic">
          <img src={service_section_img2} alt="web development illustration" className="img-fluid"/>
        </div>
      </div>
      <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
        <div className="services__content">
    ...
    <div className="row">
      ...
      <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
        <div className="services__pic">
          <img src={service_section_img3} alt="cloud hosting illustration" className="img-fluid"/>
        </div>
      </div>
    </div>
  </div>
